...
## Read the 1st file "summarySCC_PM25.rds" using the readRDS function in R
...
## the table contains number of tons of PM2.5 emitted from a specific type of source 
## for the entire year. 
...
## Read the 2nd file "Source_Classification_Code.rds" usign the readRDS function in R
